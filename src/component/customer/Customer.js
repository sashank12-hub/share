...
const handlecost=(user)=>{
  var t=  (JSON.parse( window.localStorage.getItem('Medicine'))).filter(item=>item.medicine==user.medicine)
  console.log(t)
  console.log(user)
  console.log(parseInt(t[0].price))
  console.log(t[0].discount/100);
